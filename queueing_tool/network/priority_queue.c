...
static int __pyx_pf_13queueing_tool_7network_14priority_queue_13PriorityQueue_2__init__(struct __pyx_obj_13queueing_tool_7network_14priority_queue_PriorityQueue *__pyx_v_self, PyObject *__pyx_v_keys, int __pyx_v_n) {
  ...
  /* "queueing_tool/network/priority_queue.pyx":28
 * 
 *     def __init__(self, object keys=None, int n=0):
 *         if keys is None:             # <<<<<<<<<<<<<<
 *             keys = []
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "queueing_tool/network/priority_queue.pyx":29
 *     def __init__(self, object keys=None, int n=0):
 *         if keys is None:
 *             keys = []             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (likely(PyList_CheckExact(__pyx_v_keys)) || PyTuple_CheckExact(__pyx_v_keys)) {
    ...
    __pyx_t_5 = -1; __pyx_t_4 = PyObject_GetIter(__pyx_v_keys); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  for (;;) {
    ...
    __pyx_t_7 = 0;
    __pyx_t_7 = __Pyx_GetItemInt(__pyx_v_key, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(__pyx_t_7 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_7);
  ...
  __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7cpython_5array_array), __pyx_t_4, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_GIVEREF(__pyx_t_3);
  ...
  /* "queueing_tool/network/priority_queue.pyx":32
 * 
 *         self.array_times = array.array('d', [key[0] for key in keys])
 *         self.array_edges = array.array('i', [key[1] for key in keys])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (likely(PyList_CheckExact(__pyx_v_keys)) || PyTuple_CheckExact(__pyx_v_keys)) {
    ...
    __pyx_t_5 = -1; __pyx_t_4 = PyObject_GetIter(__pyx_v_keys); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_6 = Py_TYPE(__pyx_t_4)->tp_iternext; if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  for (;;) {
    if (likely(!__pyx_t_6)) {
      if (likely(PyList_CheckExact(__pyx_t_4))) {
        if (__pyx_t_5 >= PyList_GET_SIZE(__pyx_t_4)) break;
        #if CYTHON_COMPILING_IN_CPYTHON
        __pyx_t_7 = PyList_GET_ITEM(__pyx_t_4, __pyx_t_5); __Pyx_INCREF(__pyx_t_7); __pyx_t_5++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        #else
        __pyx_t_7 = PySequence_ITEM(__pyx_t_4, __pyx_t_5); __pyx_t_5++; if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_7);
        #endif
      } else {
        if (__pyx_t_5 >= PyTuple_GET_SIZE(__pyx_t_4)) break;
        #if CYTHON_COMPILING_IN_CPYTHON
        __pyx_t_7 = PyTuple_GET_ITEM(__pyx_t_4, __pyx_t_5); __Pyx_INCREF(__pyx_t_7); __pyx_t_5++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        #else
        __pyx_t_7 = PySequence_ITEM(__pyx_t_4, __pyx_t_5); __pyx_t_5++; if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_7);
        #endif
    ...
    __Pyx_XDECREF_SET(__pyx_v_key, __pyx_t_7);
    __pyx_t_7 = 0;
    __pyx_t_7 = __Pyx_GetItemInt(__pyx_v_key, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(__pyx_t_7 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_7);
    if (unlikely(__Pyx_ListComp_Append(__pyx_t_3, (PyObject*)__pyx_t_7))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  }
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  PyTuple_SET_ITEM(__pyx_t_4, 1, __pyx_t_3);
  __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7cpython_5array_array), __pyx_t_4, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_GIVEREF(__pyx_t_3);
 ...
 */
  ...
  /* "queueing_tool/network/priority_queue.pyx":35
 * 
 *         self.sorted_times = self.array_times
 *         self.sorted_edges = self.array_edges             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_t_5 = PyObject_Length(__pyx_v_keys); if (unlikely(__pyx_t_5 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_self->size = __pyx_t_5;

  /* "queueing_tool/network/priority_queue.pyx":38
 * 
 *         self.size = len(keys)
 *         self.actual_size = self.size             # <<<<<<<<<<<<<<
 * 
 ...
 */
  if (unlikely(!__pyx_v_self->sorted_times.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
  if (unlikely(!__pyx_v_self->sorted_edges.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_ones); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  if (!__pyx_t_11) {
    __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_t_4); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_GOTREF(__pyx_t_3);
  } else {
    ...
    __pyx_t_4 = 0;
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_12, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_12 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_infty); if (unlikely(!__pyx_t_12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = PyNumber_Multiply(__pyx_t_3, __pyx_t_12); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
 ...
 */
  if (likely(PyList_CheckExact(__pyx_v_keys)) || PyTuple_CheckExact(__pyx_v_keys)) {
    ...
    __pyx_t_5 = -1; __pyx_t_7 = PyObject_GetIter(__pyx_v_keys); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_6 = Py_TYPE(__pyx_t_7)->tp_iternext; if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  for (;;) {
    if (likely(!__pyx_t_6)) {
      if (likely(PyList_CheckExact(__pyx_t_7))) {
        ...
        #if CYTHON_COMPILING_IN_CPYTHON
        __pyx_t_12 = PyList_GET_ITEM(__pyx_t_7, __pyx_t_5); __Pyx_INCREF(__pyx_t_12); __pyx_t_5++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        #else
        __pyx_t_12 = PySequence_ITEM(__pyx_t_7, __pyx_t_5); __pyx_t_5++; if (unlikely(!__pyx_t_12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_12);
        #endif
      } else {
        if (__pyx_t_5 >= PyTuple_GET_SIZE(__pyx_t_7)) break;
        #if CYTHON_COMPILING_IN_CPYTHON
        __pyx_t_12 = PyTuple_GET_ITEM(__pyx_t_7, __pyx_t_5); __Pyx_INCREF(__pyx_t_12); __pyx_t_5++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        #else
        __pyx_t_12 = PySequence_ITEM(__pyx_t_7, __pyx_t_5); __pyx_t_5++; if (unlikely(!__pyx_t_12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_12);
        #endif
    ...
    /* "queueing_tool/network/priority_queue.pyx":45
 * 
 *         for key in keys:
 *             self.q_times[key[1]] = key[0]             # <<<<<<<<<<<<<<
 * 
 * 
 */
    __pyx_t_12 = __Pyx_GetItemInt(__pyx_v_key, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(__pyx_t_12 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_13 = __pyx_PyFloat_AsDouble(__pyx_t_12); if (unlikely((__pyx_t_13 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    if (unlikely(!__pyx_v_self->q_times.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
    __pyx_t_12 = __Pyx_GetItemInt(__pyx_v_key, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(__pyx_t_12 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_14 = __Pyx_PyIndex_AsSsize_t(__pyx_t_12); if (unlikely((__pyx_t_14 == (Py_ssize_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
...
/* "queueing_tool/network/priority_queue.pyx":48
 * 
 * 
...
static PyObject *__pyx_pf_13queueing_tool_7network_14priority_queue_13PriorityQueue_4times_edges(struct __pyx_obj_13queueing_tool_7network_14priority_queue_PriorityQueue *__pyx_v_self) {
  ...
  /* "queueing_tool/network/priority_queue.pyx":49
 * 
 *     def times_edges(self):
 *         cdef int i = self.size             # <<<<<<<<<<<<<<
 *         cdef cnp.ndarray[F64_t, ndim=1] times = np.asarray(self.array_times[:i])
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_GetSlice(((PyObject *)__pyx_v_self->array_times), 0, __pyx_v_i, NULL, NULL, NULL, 0, 1, 1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = NULL;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_asarray); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_GetSlice(((PyObject *)__pyx_v_self->array_edges), 0, __pyx_v_i, NULL, NULL, NULL, 0, 1, 1); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = NULL;
  __pyx_t_8 = 0;
  ...
  __pyx_t_5 = PyTuple_New(2+__pyx_t_8); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_4 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_5, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
...
/* "queueing_tool/network/priority_queue.pyx":55
 * 
 * 
 *     def q_map(self):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_13queueing_tool_7network_14priority_queue_13PriorityQueue_6q_map(struct __pyx_obj_13queueing_tool_7network_14priority_queue_PriorityQueue *__pyx_v_self) {
  ...
  /* "queueing_tool/network/priority_queue.pyx":56
 * 
 *     def q_map(self):
 *         return np.asarray(self.q_times)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_asarray); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (unlikely(!__pyx_v_self->q_times.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_self->q_times, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
...
/* "queueing_tool/network/priority_queue.pyx":59
 * 
 *     @property
 *     def arraysize(self):             # <<<<<<<<<<<<<<
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_self->actual_size); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "queueing_tool/network/priority_queue.pyx":65
...
static PyObject *__pyx_pf_13queueing_tool_7network_14priority_queue_13PriorityQueue_10pop(struct __pyx_obj_13queueing_tool_7network_14priority_queue_PriorityQueue *__pyx_v_self) {
  ...
  /* "queueing_tool/network/priority_queue.pyx":69
 *         cdef int k
 * 
 *         self.heappop()             # <<<<<<<<<<<<<<
 *         with nogil:
 ...
 */
  ...
  /* "queueing_tool/network/priority_queue.pyx":70
 * 
 *         self.heappop()
 *         with nogil:             # <<<<<<<<<<<<<<
 *             while self.next_time < self.q_times[self.next_node]:
 ...
 */
        while (1) {
          if (unlikely(!__pyx_v_self->q_times.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L4_error;}}
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "queueing_tool/network/priority_queue.pyx":78
 * 
 *         if self.size < 0:
 *             self.size += 1             # <<<<<<<<<<<<<<
 *             return None
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = PyFloat_FromDouble(__pyx_v_self->next_time); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_self->next_node); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
...
/* "queueing_tool/network/priority_queue.pyx":86
 *     @cython.wraparound(False)
 *     @cython.nonecheck(False)
...
static PyObject *__pyx_pw_13queueing_tool_7network_14priority_queue_13PriorityQueue_13push(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("push (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_k)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("push", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 86; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "push") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 86; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_t = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_t == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 86; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_k = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_k == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 86; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("push", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 86; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
 ...
 */
  if (unlikely(!__pyx_v_self->q_times.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
  __pyx_t_1 = __pyx_v_k;
  *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_self->q_times.data) + __pyx_t_1)) )) = __pyx_v_t;

  /* "queueing_tool/network/priority_queue.pyx":89
 * 
 *         self.q_times[k] = t
 *         if self.size < self.actual_size:             # <<<<<<<<<<<<<<
 *             self.sorted_times[self.size] = t
 ...
 * 
 */
    if (unlikely(!__pyx_v_self->sorted_times.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
 ...
 *         else:
 */
    if (unlikely(!__pyx_v_self->sorted_edges.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
 ...
 */
  ...
  /* "queueing_tool/network/priority_queue.pyx":94
 * 
 *         else:
 ...
 */
  /*else*/ {
    ...
    __Pyx_INCREF(__pyx_t_5);
    __pyx_t_6 = resize_smart(((arrayobject *)__pyx_t_5), (2 * __pyx_v_self->size)); if (unlikely(__pyx_t_6 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

    /* "queueing_tool/network/priority_queue.pyx":95
 *         else:
 *             array.resize_smart(self.array_times, 2 * self.size)
 *             array.resize_smart(self.array_edges, 2 * self.size)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __Pyx_INCREF(__pyx_t_5);
    __pyx_t_6 = resize_smart(((arrayobject *)__pyx_t_5), (2 * __pyx_v_self->size)); if (unlikely(__pyx_t_6 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
    ...
    /* "queueing_tool/network/priority_queue.pyx":98
 * 
 *             self.actual_size *= 2
 *             self.sorted_times = self.array_times             # <<<<<<<<<<<<<<
 *             self.sorted_edges = self.array_edges
 ...
 * 
 */
    if (unlikely(!__pyx_v_self->sorted_times.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
    __pyx_t_9 = __pyx_v_self->size;
    *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_self->sorted_times.data) + __pyx_t_9)) )) = __pyx_v_t;

    /* "queueing_tool/network/priority_queue.pyx":102
 * 
 *             self.sorted_times[self.size] = t
 *             self.sorted_edges[self.size] = k             # <<<<<<<<<<<<<<
 * 
 *         self.size += 1
 */
    if (unlikely(!__pyx_v_self->sorted_edges.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
    __pyx_t_10 = __pyx_v_self->size;
 ...
 */
  ...
  /* "queueing_tool/network/priority_queue.pyx":105
 * 
 *         self.size += 1
 *         _siftdown(self.sorted_times, self.sorted_edges, 0, self.size-1)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  if (unlikely(!__pyx_v_self->sorted_times.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
  if (unlikely(!__pyx_v_self->sorted_edges.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
...
/* "queueing_tool/network/priority_queue.pyx":111
 *     @cython.wraparound(False)
 *     @cython.nonecheck(False)
...
static void __pyx_f_13queueing_tool_7network_14priority_queue_13PriorityQueue_heappop(struct __pyx_obj_13queueing_tool_7network_14priority_queue_PriorityQueue *__pyx_v_self) {
  ...
  /* "queueing_tool/network/priority_queue.pyx":115
 *         cdef int last_node, return_node
 * 
 *         self.size -= 1             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "queueing_tool/network/priority_queue.pyx":116
 * 
 *         self.size -= 1
 *         last_time = self.sorted_times[self.size]             # <<<<<<<<<<<<<<
 *         last_node = self.sorted_edges[self.size]
 * 
 */
  if (unlikely(!__pyx_v_self->sorted_times.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 116; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
  __pyx_t_1 = __pyx_v_self->size;
 ...
 *         if self.size > 0:
 */
  if (unlikely(!__pyx_v_self->sorted_edges.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "queueing_tool/network/priority_queue.pyx":120
 * 
 *         if self.size > 0:
 *             return_time = self.sorted_times[0]             # <<<<<<<<<<<<<<
 *             return_node = self.sorted_edges[0]
 * 
 */
    if (unlikely(!__pyx_v_self->sorted_times.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 120; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
    __pyx_t_4 = 0;
 ...
 */
    if (unlikely(!__pyx_v_self->sorted_edges.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 121; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
    __pyx_t_5 = 0;
 ...
 * 
 */
    if (unlikely(!__pyx_v_self->sorted_times.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 123; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
    __pyx_t_6 = 0;
    *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_self->sorted_times.data) + __pyx_t_6)) )) = __pyx_v_last_time;

    /* "queueing_tool/network/priority_queue.pyx":124
 * 
 *             self.sorted_times[0] = last_time
 *             self.sorted_edges[0] = last_node             # <<<<<<<<<<<<<<
 * 
 ...
 */
    if (unlikely(!__pyx_v_self->sorted_edges.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 124; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
    __pyx_t_7 = 0;
 ...
 */
    if (unlikely(!__pyx_v_self->sorted_times.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");{__pyx_filename = __pyx_f[0]; __pyx_lineno = 126; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
 ...
 */
    ...
    /* "queueing_tool/network/priority_queue.pyx":129
 * 
 *             self.next_time = return_time
 *             self.next_node = return_node             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
  /*else*/ {
    ...
    /* "queueing_tool/network/priority_queue.pyx":132
 *         else:
 *             self.next_time = last_time
 *             self.next_node = last_node             # <<<<<<<<<<<<<<
 * 
...
/* "queueing_tool/network/priority_queue.pyx":138
 * @cython.wraparound(False)
 * @cython.nonecheck(False)
...
static CYTHON_INLINE void __pyx_f_13queueing_tool_7network_14priority_queue__siftdown(__Pyx_memviewslice __pyx_v_heap, __Pyx_memviewslice __pyx_v_hmap, int __pyx_v_startpos, int __pyx_v_pos) {
  ...
  /* "queueing_tool/network/priority_queue.pyx":142
 *     cdef int parentpos, mapitem, father
 * 
 *     newitem = heap[pos]             # <<<<<<<<<<<<<<
 *     mapitem = hmap[pos]
 ...
 */
  ...
  /* "queueing_tool/network/priority_queue.pyx":143
 * 
 *     newitem = heap[pos]
 *     mapitem = hmap[pos]             # <<<<<<<<<<<<<<
 *     while pos > startpos:
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "queueing_tool/network/priority_queue.pyx":150
 * 
 *         if newitem < parent:
 *             heap[pos] = parent             # <<<<<<<<<<<<<<
 *             hmap[pos] = father
 ...
 */
  ...
  *((double *) ( /* dim=0 */ (__pyx_v_heap.data + __pyx_t_8 * __pyx_v_heap.strides[0]) )) = __pyx_v_newitem;
  ...
  /* "queueing_tool/network/priority_queue.pyx":157
 * 
 *     heap[pos] = newitem
 *     hmap[pos] = mapitem             # <<<<<<<<<<<<<<
 * 
...
/* "queueing_tool/network/priority_queue.pyx":163
 * @cython.wraparound(False)
 * @cython.nonecheck(False)
...
static CYTHON_INLINE void __pyx_f_13queueing_tool_7network_14priority_queue__siftup(__Pyx_memviewslice __pyx_v_heap, __Pyx_memviewslice __pyx_v_hmap, int __pyx_v_pos, int __pyx_v_endpos) {
  ...
  /* "queueing_tool/network/priority_queue.pyx":166
 *     cdef double newitem
 *     cdef int childpos, rightpos, mapitem
 ...
 */
  ...
  /* "queueing_tool/network/priority_queue.pyx":169
 * 
 *     newitem = heap[pos]
 *     mapitem = hmap[pos]             # <<<<<<<<<<<<<<
 *     # Bubble up the smaller child until hitting a leaf.
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "queueing_tool/network/priority_queue.pyx":178
 * 
 *         if rightpos < endpos and not heap[childpos] < heap[rightpos]:
 *             childpos = rightpos             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "queueing_tool/network/priority_queue.pyx":181
 * 
 *         # Move the smaller child up.
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_heap.data + __pyx_t_8 * __pyx_v_heap.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_heap.data + __pyx_t_7 * __pyx_v_heap.strides[0]) )));
    ...
    /* "queueing_tool/network/priority_queue.pyx":182
 *         # Move the smaller child up.
 *         heap[pos] = heap[childpos]
 *         hmap[pos] = hmap[childpos]             # <<<<<<<<<<<<<<
 *         pos = childpos
 ...
 */
  ...
  /* "queueing_tool/network/priority_queue.pyx":188
 *     # The leaf at pos is empty now.  Put newitem there, and bubble it up
 ...
 */
  ...
  *((double *) ( /* dim=0 */ (__pyx_v_heap.data + __pyx_t_11 * __pyx_v_heap.strides[0]) )) = __pyx_v_newitem;
  ...
  /* "queueing_tool/network/priority_queue.pyx":189
 *     # to its final resting place (by sifting its parents down).
 *     heap[pos] = newitem
 *     hmap[pos] = mapitem             # <<<<<<<<<<<<<<
 *     _siftdown(heap, hmap, startpos, pos)
...
/* "queueing_tool/network/priority_queue.pyx":196
 * @cython.wraparound(False)
 * @cython.nonecheck(False)
 ...
 */
  for (__pyx_t_1 = __Pyx_div_long(__pyx_v_n, 2)-1; __pyx_t_1 >= 0; __pyx_t_1-=1) {
    ...
    /* "queueing_tool/network/priority_queue.pyx":199
 *     cdef int i
 *     for i in reversed(range(n//2)):
 *         _siftup(heap, hmap, i, n)             # <<<<<<<<<<<<<<
 */
...
static int __Pyx_InitCachedBuiltins(void) {
  ...
  __pyx_builtin_reversed = __Pyx_GetBuiltinName(__pyx_n_s_reversed); if (!__pyx_builtin_reversed) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 198; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_t_1 = __Pyx_GetNameInClass((PyObject *)__pyx_ptype_13queueing_tool_7network_14priority_queue_PriorityQueue, __pyx_n_s_arraysize); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem((PyObject *)__pyx_ptype_13queueing_tool_7network_14priority_queue_PriorityQueue->tp_dict, __pyx_n_s_arraysize, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
